...
(function () {
  ...
  var BUBBLE_UI = {
    en: {
      ...
      approving: 'Approving…',
      stage5Ok: 'Build approved. Sandbox branch automation runs next.',
    ...
    es: {
      ...
      approving: 'Aprobando…',
      stage5Ok: 'Build aprobado. Automatización de rama sandbox en curso.',
      stage5Title: 'Listo',
    ...
    fr: {
      ...
      stage5Ok: 'Build approuvé. Automatisation de la branche sandbox en cours.',
      stage5Title: 'Terminé',
    ...
    de: {
      ...
      stage5Ok: 'Build freigegeben. Sandbox-Branch-Automation läuft als Nächstes.',
      stage5Title: 'Fertig',
    ...
    pt: {
      ...
      approving: 'Aprovando…',
      stage5Ok: 'Build aprovado. Automação do branch sandbox em seguida.',
