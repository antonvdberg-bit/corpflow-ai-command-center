...
| **Environment classification (`corpflow_test` vs `client_production`)** | **`docs/operations/CORPFLOW_ENVIRONMENT_CLASSIFICATION_V1.md`**, ADR `docs/decisions/20260729-corpflow-test-vs-client-production.md` |
