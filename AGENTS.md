...
- **Current queue** (`docs/execution/WEEKEND_EXECUTION_QUEUE.md`): Goal 1 — *Stabilize permanent infrastructure and reduce Anton as runtime bottleneck*. All Goal 1 packets are docs-only by design.
