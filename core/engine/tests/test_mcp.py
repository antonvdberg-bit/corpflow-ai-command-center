...
class TestMCPClientManager:
    ...
    def test_import_mcp_client(self):
        ...
        try:
            from engine.src.mcp_client import MCPClientManager, MCPTool, MCPServerConnection
    ...
    def test_mcp_tool_dataclass(self):
        ...
        from engine.src.mcp_client import MCPTool
    ...
    def test_mcp_server_connection_dataclass(self):
        ...
        from engine.src.mcp_client import MCPServerConnection
...
class TestMCPTools:
    ...
    def test_import_mcp_tools(self):
        ...
        from engine.src.tools.mcp_tools import (
            list_mcp_servers,
            list_mcp_tools,
            get_mcp_tool_help,
            mcp_health_check,
    ...
    def test_list_mcp_servers_no_manager(self):
        ...
        from engine.src.tools.mcp_tools import list_mcp_servers, _set_mcp_manager
    ...
    def test_list_mcp_tools_no_manager(self):
        ...
        from engine.src.tools.mcp_tools import list_mcp_tools, _set_mcp_manager
    ...
    def test_get_mcp_tool_help_no_manager(self):
        ...
        from engine.src.tools.mcp_tools import get_mcp_tool_help, _set_mcp_manager
    ...
    def test_mcp_health_check_no_manager(self):
        ...
        from engine.src.tools.mcp_tools import mcp_health_check, _set_mcp_manager
...
class TestMCPToolWrapper:
    ...
    def test_tool_wrapper_metadata(self):
        ...
        from engine.src.mcp_client import MCPClientManager, MCPServerConnection, MCPTool
...
class TestMCPShutdown:
    ...
    def test_shutdown_skips_missing_context_managers(self):
        """Shutdown should not warn when optional context managers are absent."""
        import asyncio

        from engine.src.mcp_client import MCPClientManager, MCPServerConnection
