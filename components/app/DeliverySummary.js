                ...
                {rows.map((row) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td>{String(row.product_service || '—')}</td>
                      <td>{String(row.delivery_stage || '—')}</td>
                      <td>{String(row.owner || 'Unassigned')}</td>
                      <td>{String(row.current_blocker || 'None recorded')}</td>
                      <td>
                      ...
                      <td>
                        {protectedGate ? (
                          <span className="cf-app-badge" data-kind="protected" data-testid="delivery-protected-badge">
