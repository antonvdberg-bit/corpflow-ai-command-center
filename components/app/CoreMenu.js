 ...
 * Links Delivery to the Operating Workspace Delivery summary (#1005).
 * Operations remains on /change. My Work, Prospects, Workbench, Pipeline, and Action Queue stay dedicated routes.
 *
 * @param {{
 *   active: string,
