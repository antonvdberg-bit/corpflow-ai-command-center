...
/**
 * @param {{ steps: { step: string, title: string, body: string }[] }} props
 */
export default function DeliverySteps({ steps }) {
  return (
    <section style={cfSection}>
      <p style={cfKicker}>How delivery works</p>
      <h2 style={cfH2}>From discovery to visible output</h2>
      <div style={cfGrid}>
        {steps.map((s) => (
