...
export default function Home({ mode, site, host, homepageAssets, leadRescueAssets, search }) {
  ...
  // CIPC Desk standing tenant — CorpFlowAI photo+glass presentation (UI only).
  // Must not use Lux shells or the generic HNW TenantSite enquire form.
  if (mode === 'tenant_site' && site?.tenant_id === 'cipc-desk') {
