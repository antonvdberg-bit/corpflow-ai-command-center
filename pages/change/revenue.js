...
const styles = {
  ...
  shell: { maxWidth: 840, margin: '0 auto', padding: '32px 20px 64px', minWidth: 0 },
  ...
  offerGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(220px, 100%), 1fr))', gap: 12, minWidth: 0 },
  offerCard: {
    background: c.panel,
  ...
  linkList: { listStyle: 'none', margin: 0, padding: 0, minWidth: 0 },
  linkRow: {
    display: 'flex',
    flexWrap: 'wrap',
    gap: 8,
