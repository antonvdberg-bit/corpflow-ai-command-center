...
**Prerequisite refresh:** #874 (current-main package vehicle; supersedes stale open PR #771 content)
...
| `prerequisite-refresh-874.json` | #874 repo-only refresh evidence + operator remaining steps |
