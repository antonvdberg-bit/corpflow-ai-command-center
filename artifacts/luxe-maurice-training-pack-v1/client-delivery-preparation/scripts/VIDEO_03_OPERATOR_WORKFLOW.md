...
| **Narrator** | “Operators manage lead workflow in Change Console. Open LEADS · LuxeMaurice CRM — this is where stage, notes, and next actions are updated today.” |
| **Action** | Sign in if needed. Open `/change`. Scroll to LEADS · LuxeMaurice CRM (concierge). |
| **Result** | Change Console LEADS panel loads. |
...
| **Action** | Show internal / test if needed. Click the training lead. Point to **Focused on …**, **Show all leads**, **Clear selection**, and **Focus list on this lead**. |
