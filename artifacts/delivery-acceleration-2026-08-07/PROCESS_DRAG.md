# Process drag — 2026-08-07

Explicit list of items that consume operator/agent time without client-handable output.

| Drag type | Examples | Disposition |
|-----------|----------|-------------|
| Repeated reviews / dual agents on same issue | Two dispatcher agents for #791 (`…94ae` + `…d259`); dual #778, #773, #767, #787 | Keep one canonical; close rest; do not repair |
| Lifecycle-only PRs | #788, #789 synthetic #661 markers | Close both if #790 already on main; else keep one max |
...
**Rule applied:** delivery velocity above process drag (#795).
