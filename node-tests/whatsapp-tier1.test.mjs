/**
 * #1137 WhatsApp Tier 1 — reusable manual contact (no API / send runtime).
 */
...
describe('#1137 WhatsApp Tier 1 URL normalization', () => {
...
describe('#1137 WhatsApp Tier 1 prefilled-message encoding', () => {
...
describe('#1137 WhatsApp Tier 1 phone-number validation', () => {
...
describe('#1137 WhatsApp Tier 1 tenant-safe configuration', () => {
...
describe('#1137 WhatsApp Tier 1 accessibility and fallback', () => {
...
describe('#1137 WhatsApp Tier 1 local QR encoder', () => {
