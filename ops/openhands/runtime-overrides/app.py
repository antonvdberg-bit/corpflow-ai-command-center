...
from openhands.app_server.runtime_proxy_router import (
    install_browser_conversation_url_patch,
...
# Must be registered before the SPA catch-all mount.
app.include_router(runtime_proxy_router, prefix='/runtime', tags=['Runtime Proxy'])
