...
**Current onboarding packet F (#1139 / current-main #1220):** payment-evidence vs later Payment Entry split is `docs/runbooks/ERPNEXT_BANK_RECONCILIATION_OPERATOR_RUNBOOK_V1.md`. This file remains the sandbox clearance-rule history.
