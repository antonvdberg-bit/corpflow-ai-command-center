...
**Status:** Operator Delivery surface projects existing ERPNext Project/Issue references. **DELIVERY -> ERPNEXT PROJECT/SUPPORT CURRENT-MAIN READY FOR MERGE** when the recorded #1097/#1144 contract is present on exact current `main`.
**Source issue:** [#1170](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1170) (repair of [#1156](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1156); supersedes unmergeable PR #1158)
