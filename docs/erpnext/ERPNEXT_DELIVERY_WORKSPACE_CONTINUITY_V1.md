...
**Status:** Operator Delivery surface projects existing ERPNext Project/Issue references. **DELIVERY -> ERPNEXT PROJECT/SUPPORT CONTINUITY USABLE** when the recorded #1097/#1144 contract is present.
**Source issue:** [#1156](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1156)
...
**Merged foundations:** PR #1144 ERPNext Projects/Support; PR #1142 Operating Workspace Delivery
