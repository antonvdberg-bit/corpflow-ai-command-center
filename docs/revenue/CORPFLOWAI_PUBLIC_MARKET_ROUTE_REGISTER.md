...
| ----- | ------- | ------------ | ------ | ------------- | ----------- | --------------- | ------ | ----- | --------- | --------------- | --------------- |
| `/` | Market entrance — enquiry recovery first, then service paths | Owner-led Mauritius SMEs | **Aligned (21-Day Traction)** | CorpFlow public photo shell | Request a 15-minute diagnosis | `/enquiry-recovery#diagnosis` | Header menu + responsive grid | Trust/safety section + footer privacy/terms | Plausible when configured | **KEEP_AND_ALIGN** | Live verify after merge |
| `/enquiry-recovery` | Live Enquiry Recovery Sprint campaign | Qualified Mauritius SMEs | **Aligned** | Photo + glass | Request a 15-minute diagnosis | `#diagnosis` form (`offer_slug=ai-lead-rescue`) | Header + form | Scarcity + qualification + no-guarantee | `revenue_offer_cta_click` / `lr_primary_cta_click` | **KEEP_AND_ALIGN** | Primary WhatsApp destination |
| `/offers/ai-lead-rescue` | Same commercial terms as Enquiry Recovery (SKU alias) | Same | **Aligned** | Photo + glass + shared header | Request a 15-minute diagnosis | `#discovery` form | Glass stack + shared nav | FAQ + not-included + footer | Event `revenue_offer_cta_click` | **KEEP_AND_ALIGN** | Live verify |
...
| Route | Purpose | Target buyer | Status | Visual family | Primary CTA | CTA destination | Mobile | Trust | Analytics | Launch decision | Required action |
| ----- | ------- | ------------ | ------ | ------------- | ----------- | --------------- | ------ | ----- | --------- | --------------- | --------------- |
| `/lead-rescue` | Alias of Enquiry Recovery (historic URL kept live) | Same as `/enquiry-recovery` | Specialist | Photo + glass (EnquiryRecoveryCampaignPage) | Request a 15-minute diagnosis | `#diagnosis` | Header + form | Same as campaign | CTA click events | **KEEP_AS_ALIAS** | Do not show USD 150 |
