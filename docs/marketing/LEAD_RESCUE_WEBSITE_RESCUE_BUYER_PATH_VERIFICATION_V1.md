...
**Delivery Reality:** #1164 footer/hero copy is live on current Production (`b7314117`). The #1174 demo lock-label fix is local on this branch until merge. Operational completion for the demo lock line stays **PARTIAL** until Anton merges and live `/demo/website-rescue` shows **Website Rescue**.
