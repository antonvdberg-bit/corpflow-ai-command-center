...
| `buying_ap_supplier` | Buying / AP / Supplier | none | Supplier / Purchase Invoice (Purchase Order **DEFER**) | **ERPNext authoritative** | #1098 readiness packet; AI cannot approve suppliers; invoice existence never authorizes payment |
