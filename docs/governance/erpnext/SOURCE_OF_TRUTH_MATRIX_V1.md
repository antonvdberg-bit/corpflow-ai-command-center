...
| Audit | #882 draft quotations/invoices; #919 Prestige pack **not sent**. Sales Order is not required for services. #1056 maps the CF1018 draft MUR Quotation path and stops Sales Invoice posting at accountant foundation. |
...
| Audit | #920 `PROJ-0001`, Tasks `TASK-2026-00013`–`00024`, Timesheet `TS-2026-00001` draft. |
...
| Audit | #920 `ISS-2026-00001`. Workflow/Notification still HTTP 403 — no email. |
