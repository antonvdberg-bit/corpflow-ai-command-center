...
| Audit | #882 draft quotations/invoices; #919 Prestige pack **not sent**. Sales Order is not required for services. #1056/#1166 maps the CF1018 draft MUR Quotation `SAL-QTN-2026-00005` and stops Sales Invoice posting at accountant foundation. #1196 GET: that quotation’s `terms` body is empty, so the standard PDF is not yet a client document. |
