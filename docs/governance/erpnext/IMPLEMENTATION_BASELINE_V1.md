...
| 5 | Business process configuration | **PARTIAL** | Lead → Opportunity → Customer, draft Quotation/Invoice, Project/Task/Timesheet, and Issue are proven on hosted test. Nothing is submitted or sent. Buying/AP and bank posting are not started. #1139 maps the manual/import-first recon path only. |
