...
| Options considered | Merge stale #1141 or closed stale #1221; redesign banking; land the proven helper/docs/evidence onto current `main` after CURRENT-MAIN REPAIR and close #1141/#1221 |
| Evidence reviewed | #1139 GET-only hosted-test as `integrations@corpflowai.com`; #1055 template CoA / 0 Bank Account rows; #551/#714 rail; #1166 invoice-does-not-approve gate; Phase C synthetic recon arithmetic; accountant pack §8; generation-2 re-probe from `ea2a45a90a4fde7043b89989e985194da3605bff` |
| Decision | Land [`ERPNEXT_BANK_RECONCILIATION_READINESS_V1.md`](../../erpnext/ERPNEXT_BANK_RECONCILIATION_READINESS_V1.md) on current `main`. Manual/import-first. Bank-feed **NOT REQUIRED**. Payment evidence never authorizes Payment Entry. Invoice existence never grants Proceed Approved. Synthetic offline proof only. Close #1141 and #1221 without merge. |
...
| Supersedes / superseded-by | Current-main replacement for stale PR #1141 / #1139 and closed stale PR #1221. Does **not** supersede Version 2, #918 `payment_evidence` blocked bridge, #1055, or #1166. |
