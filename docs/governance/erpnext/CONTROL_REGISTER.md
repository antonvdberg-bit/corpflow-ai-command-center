...
| C-BNK-01 | Manual/import-first bank recon; no credentials or live feed in repo/ERPNext | Anton / accountant | **PROVEN** (gate) | #1139: Bank Account rows = 0; Payment Entry = 0; Bank Transaction = 0; bank-feed **NOT REQUIRED**. Posting waits on #1055. |
