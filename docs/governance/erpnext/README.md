...
| Buying / AP readiness (#1098) | [`docs/erpnext/ERPNEXT_BUYING_AP_READINESS_V1.md`](../../erpnext/ERPNEXT_BUYING_AP_READINESS_V1.md) | **ERPNext BUYING / AP READINESS READY FOR ACCOUNTANT CONFIGURATION** — Supplier rules, PO **DEFER**, payment segregated. No PI submit. |
...
- Buying / AP readiness: [#1098](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1098) — `docs/erpnext/ERPNEXT_BUYING_AP_READINESS_V1.md`
