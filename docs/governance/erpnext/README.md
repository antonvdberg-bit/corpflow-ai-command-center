...
| Buying / AP readiness (#1098 / current-main #1213) | [`docs/erpnext/ERPNEXT_BUYING_AP_READINESS_V1.md`](../../erpnext/ERPNEXT_BUYING_AP_READINESS_V1.md) | **ERPNext BUYING/AP CURRENT-MAIN READY FOR ACCOUNTANT CONFIGURATION** — Supplier rules, PO **DEFER**, payment segregated. GET-only on current `main` (`be671871`). Closed PR #1217 must not resume. Close stale PR #1107 without merge. No PI submit. |
...
- Buying / AP readiness: [#1098](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1098) / current-main [#1213](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1213) — `docs/erpnext/ERPNEXT_BUYING_AP_READINESS_V1.md`
