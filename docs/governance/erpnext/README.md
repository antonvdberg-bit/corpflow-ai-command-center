...
| Onboarding E Projects / Support (#1097) | [`docs/erpnext/ERPNEXT_PROJECTS_SUPPORT_OPERATIONAL_PROOF_V1.md`](../../erpnext/ERPNEXT_PROJECTS_SUPPORT_OPERATIONAL_PROOF_V1.md) | **ERPNext PROJECTS / SUPPORT OPERATIONAL PROOF READY** — reused #920 Project/Issue; Timesheet DEFER; SLA deferred. |
