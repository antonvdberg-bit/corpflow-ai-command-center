...
| Onboarding E Projects / Support (#1097 / current-main #1134 / acceptance #1202) | [`docs/erpnext/ERPNEXT_PROJECTS_SUPPORT_OPERATIONAL_PROOF_V1.md`](../../erpnext/ERPNEXT_PROJECTS_SUPPORT_OPERATIONAL_PROOF_V1.md) / [`docs/erpnext/ERPNEXT_PROJECTS_SUPPORT_OPERATIONAL_ACCEPTANCE_V1.md`](../../erpnext/ERPNEXT_PROJECTS_SUPPORT_OPERATIONAL_ACCEPTANCE_V1.md) | **ERPNext PROJECTS / SUPPORT OPERATIONALLY USABLE** — GET/read-only acceptance of reused #920/#1097 Project/Issue; Timesheet DEFER; SLA deferred. Close stale PR #1102 without merge. |
