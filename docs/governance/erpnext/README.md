...
| Buying / AP readiness (#1098 / current-main #1213) | [`docs/erpnext/ERPNEXT_BUYING_AP_READINESS_V1.md`](../../erpnext/ERPNEXT_BUYING_AP_READINESS_V1.md) | **ERPNext BUYING/AP CURRENT-MAIN READY FOR ACCOUNTANT CONFIGURATION** — Supplier rules, PO **DEFER**, payment segregated. GET-only on current `main`. Close stale PR #1107 without merge. No PI submit. |
