...
| Onboarding F bank / reconciliation (#1139 / current-main #1220) | [`docs/erpnext/ERPNEXT_BANK_RECONCILIATION_READINESS_V1.md`](../../erpnext/ERPNEXT_BANK_RECONCILIATION_READINESS_V1.md) | **ERPNext BANK/RECONCILIATION CURRENT-MAIN READY FOR ACCOUNTANT CONFIGURATION** — manual/import-first; no live bank mutation. Close stale PR #1141 and closed stale PRs #1221 / #1229 without merge. |
