...
| Onboarding C selling / quote-to-cash (#1056) | [`docs/erpnext/ERPNEXT_SELLING_QUOTE_TO_CASH_V1.md`](../../erpnext/ERPNEXT_SELLING_QUOTE_TO_CASH_V1.md) | **NOT READY — BLOCKED BY ACCOUNTANT FOUNDATION** — CF1018 draft MUR Quotation proven; SI posting waits on #1055. |
