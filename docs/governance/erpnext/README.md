...
| Onboarding F bank / reconciliation (#1139) | [`docs/erpnext/ERPNEXT_BANK_RECONCILIATION_READINESS_V1.md`](../../erpnext/ERPNEXT_BANK_RECONCILIATION_READINESS_V1.md) | **ERPNext BANK / RECONCILIATION READINESS READY FOR ACCOUNTANT CONFIGURATION** — manual/import-first; no live bank mutation. |
