...
| R-ERP-05 | AI spend, supplier approval, or unapproved external quotation | Anton | Zero default spend; Anton approves suppliers; every external quote needs Anton commercial + presentation approval; invoice existence never authorizes payment | In force | Version 2 §5; `.cursor/rules/erpnext-strategy.mdc`; #1098 / #1213 `docs/erpnext/ERPNEXT_BUYING_AP_READINESS_V1.md` | **PROVEN** (rule recorded) | Keep factory packets from sending or paying |
