...
| [#1196](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1196) | GET/read-only client-document acceptance of `SAL-QTN-2026-00005`. Identity/MUR/line/validity proven. Exact blocker: empty `quotation.terms` so the standard PDF omits CF882 terms/seller identity. | ERPNext PUT of terms; send; Sales Invoice submit |
