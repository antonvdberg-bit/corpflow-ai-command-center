...
| [#1177](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1177) | Commercial Workspace quotation-evidence live usability probe: hosted GET/PDF for `SAL-QTN-2026-00001` / `00005`; proof drilldown; Tenant 403. Live leads currently store no Quotation id. | Write a quotation pointer onto Postgres; infer an ERPNext id; submit/send |
