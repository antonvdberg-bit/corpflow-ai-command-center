...
**Companion (Sheets/n8n ops):** `docs/product/PRODUCT_A_NON_GHL_DATA_WORKFLOW_PACKET.md` — CSV templates under `docs/product/product-a-csv-templates/`. Wire n8n per the ops packet or this webhook spec.
