...
| [CIPC_DESK_RESEARCH_PACKET_V1.md](./CIPC_DESK_RESEARCH_PACKET_V1.md) | CIPC Desk brand/domain options, competitor pricing language, SME vs partner routes, OSS reuse, conflict safeguards — **NO IMPLEMENTATION AUTHORIZED** | 2026-07-30 |
