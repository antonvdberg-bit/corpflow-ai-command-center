...
| [OPERATING_TENANT_WORKSPACE_CONSOLIDATION_V1.md](./OPERATING_TENANT_WORKSPACE_CONSOLIDATION_V1.md) | #772 / #994 / #996 / #997 / #995 / #999 / #1004 / #1005 — Operating / Tenant Workspace + Prospect Operations + Today / My Work + shared Prospect detail + Prospect Workbench + Pipeline + Action Queue + Clients + Commercial + Delivery |
...
| [Launch-product buyer-to-delivery continuity](../revenue/LAUNCH_PRODUCT_BUYER_TO_DELIVERY_CONTINUITY_V1.md) | #1218 — Lead Rescue + Website Rescue public → Prospect/Commercial → recorded quotation → Tenant progress on current `main` |
