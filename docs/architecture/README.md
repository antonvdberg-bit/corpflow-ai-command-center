...
| [OPERATING_TENANT_WORKSPACE_CONSOLIDATION_V1.md](./OPERATING_TENANT_WORKSPACE_CONSOLIDATION_V1.md) | #772 — Operating / Tenant Workspace audit + first Prospect Operations route (`/app/prospects`) |
