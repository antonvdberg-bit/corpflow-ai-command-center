...
**Status:** Phase 1 audit + Prospect Operations list + Today / My Work **shipped**. Shared Prospect detail / actions / history shipped at `/app/prospects/[id]` (#994). Shared Prospect Workbench shipped at `/app/workbench` (#996).
...
7. Not see Prospect Operations, Today / My Work, shared detail, Workbench, or other internal commercial desks inside the Tenant Workspace.
