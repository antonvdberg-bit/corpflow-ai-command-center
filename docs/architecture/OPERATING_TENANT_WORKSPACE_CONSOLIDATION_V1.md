...
### This slice (Delivery summary — #1005 / #1119)
...
Tenant Workspace placeholder-nav retirement shipped in #1073. Tenant-only chrome and `/app` tenant-session redirect shipped in #1006 (`docs/architecture/TENANT_WORKSPACE_SIMPLIFICATION_V1.md`). Delivery summary ships in #1005 / #1119.
