...
- Related code paths (Tier 1 reusable capability, #1137 — **not attached** to a public surface): `lib/whatsapp/href.js`, `lib/whatsapp/tier1.js`, `lib/whatsapp/qr-svg.js`, `components/whatsapp/WhatsAppTier1Contact.js`, `config/whatsapp-tier1.v1.json`, operator note `docs/operations/WHATSAPP_TIER1_MANUAL_CONTACT.md`. Café International `wa.me` links reuse `buildWhatsAppMeHref`.
