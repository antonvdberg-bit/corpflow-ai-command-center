...
**Date:** 2026-08-27
**Status:** accepted for #1184 current-main repair of #1156 (PR implementation; live corpflow_test after merge)
**Issue:** [#1184](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1184) (source [#1156](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1156); supersedes unmergeable PR #1158 and paused [#1170](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1170) for implementation capacity only)
...
PR #1158 proved the Delivery projection, then `main` advanced with Operating Workspace action overview (#1159 / PR #1161), Commercial quotation-evidence (#1160 / PR #1162), and selling/quote-to-cash (#1166 / PR #1168). #1170 / PR #1172 attempted the first current-main repair and is preserved as paused evidence. This ADR is the #1184 current-main repair, not a redesign.
