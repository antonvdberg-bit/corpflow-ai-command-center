...
| Date | Topic | File |
|------|--------|------|
| 2026-08-28 | ERPNext Buying/AP current-main GET acceptance (#1213 gen 2; reuses #1098; closed PR #1217 must not resume) | `20260826-erpnext-buying-ap-readiness.md` (`JE-2026-08-28-1`) |
