...
| Date | Topic | File |
|------|--------|------|
| 2026-08-27 | ERPNext onboarding F — bank/reconciliation current-main landing after CURRENT-MAIN REPAIR; bank-feed NOT REQUIRED (#1220; reuses #1139; do not merge stale PR #1141 or #1221) | `20260827-erpnext-bank-reconciliation-readiness.md` (`JE-2026-08-27-4`) |
