...
| Date | Topic | File |
|------|--------|------|
| 2026-08-27 | ERPNext onboarding E — Projects / Support operational acceptance GET-only on reused #920/#1097 records (#1202) | `20260827-erpnext-projects-support-ops-acceptance.md` (`JE-2026-08-27-4`) |
