...
| Date | Topic | File |
|------|--------|------|
| 2026-08-27 | ERPNext MUR quotation client-document acceptance — GET-only, empty terms is the print blocker (#1196) | `20260827-erpnext-mur-quotation-client-document.md` (`JE-2026-08-27-4`) |
