...
| Date | Topic | File |
|------|--------|------|
| 2026-08-27 | Delivery Workspace projects existing ERPNext Project/Issue references on current main (#1184; reuses #1156 / PR #1158; supersedes paused #1170) | `20260827-delivery-erpnext-continuity.md` (`JE-2026-08-27-4`) |
