...
**Issues:** [#1137](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/1137) (this packet), parent [#702](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/702) / [#492](https://github.com/antonvdberg-bit/corpflow-ai-command-center/issues/492).  
...
2. Set `enabled` to `true` only when a later delivery approval attaches the component to a named surface.
