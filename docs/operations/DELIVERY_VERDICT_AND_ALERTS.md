...
### Email and Telegram via n8n

Exception-only operator notifications route through n8n (`corpflow.ops_alert.v1`, Lead Rescue intake) or direct Telegram helpers for CI failures.
