 ...
 *
 * Client-facing rename stage 1 (#619): public wordmark naming is
 * Rare & Exclusive / Rare & Exclusive Collection. Technical identifiers,
 * tenant_id, host mappings, filenames, and imports remain unchanged.
 *
...
export const LUXE_MAURICE_DESIGN_PILLARS = Object.freeze([
  Object.freeze({ key: 'exclusive', label: 'Exclusive', sub: 'Invitation only' }),
  Object.freeze({ key: 'strategic', label: 'Strategic', sub: 'Forward thinking' }),
  Object.freeze({ key: 'private', label: 'Private', sub: 'Discreet & secure' }),
  Object.freeze({ key: 'extraordinary', label: 'Extraordinary', sub: 'Exceptional quality' }),
]);

/** Stage-1 public signature; permanent logo and visual identity remain gated. */
export const LUXE_MAURICE_BRAND_SIGNATURE = 'Rare & Exclusive Collection';

/** Public strapline retaining Mauritius positioning. */
