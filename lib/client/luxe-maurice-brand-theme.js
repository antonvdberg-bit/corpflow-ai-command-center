...
/** Canonical technical signature retained during presentation-only rename stage. */
export const LUXE_MAURICE_BRAND_SIGNATURE = 'Private. Curated. Considered.';

/** Canonical technical strapline retained during presentation-only rename stage. */
