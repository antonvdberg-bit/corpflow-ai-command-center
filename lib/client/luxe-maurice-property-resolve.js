...
export function resolveLuxPropertyRef(ref) {
  ...
  if (curated) {
    ...
    const defaultHighlights = [
      ...
      'Availability and private previews are confirmed through the Rare & Exclusive Collection concierge.',
  ...
  if (feed) {
    return {
      ...
      highlights: [
        ...
        'Indicative reference preview — final availability and terms are confirmed privately by your advisor.',
        'Nothing here is a firm offer; terms are agreed in writing through a private advisory conversation.',
      ],
    };
  }
