...
export const LUX_PROPERTIES_PUBLIC_COPY = {
  ...
  guidanceBody:
    'This is a private-access collection, not an open property catalogue. Opportunities are prepared for review, then introduced with discretion. Request private access when you wish an advisor to qualify your enquiry and select what can be shared next.',
