...
export const RARE_EXCLUSIVE_PAGE_CONTENT = Object.freeze({
  about: Object.freeze({
    ...
    lead:
      `${BRAND} is a private-access platform for curated Mauritius opportunities, supported by a simple concierge enquiry and operator review process. Introductions are curated. Conversations begin by invitation.`,
    metaTitle: `About · ${BRAND}`,
    metaDescription:
      `About ${BRAND} — a private-access platform for curated Mauritius opportunities with concierge enquiry and operator review. Invitation-only introductions.`,
    visual: 'advisory',
    sections: Object.freeze([
      ...
      Object.freeze({
        heading: 'How we work',
        body:
          'Opportunities are prepared for review before they appear. A private-access request is received, qualified, matched to suitable information, and followed up under controlled introduction. We do not run open listing catalogues, public auctions of attention, or mass-market property websites.',
      }),
      Object.freeze({
        heading: 'What we are not',
        body:
          'We are not an open listing catalogue, not a volume brokerage site, and not a substitute for legal, tax, or immigration counsel. Contextual notes about Mauritius living are descriptive only; specialists are introduced where appropriate.',
      }),
      Object.freeze({
  ...
  contact: Object.freeze({
    ...
    lead:
      'Share what you are seeking. Your note is received for confidential review, qualified by advisory, and answered with controlled follow-up — typically within one business day. Suitable introductions continue by appointment.',
    metaTitle: `Contact · ${BRAND}`,
    metaDescription:
      `Contact ${BRAND} private advisory. Request private access for residence, partnership, relocation, or ownership support in Mauritius.`,
    visual: 'advisory',
    sections: Object.freeze([
      Object.freeze({
      ...
      Object.freeze({
        ...
        body:
          'Request received → request qualified → suitable information selected → controlled follow-up. You receive a considered response — typically within one business day — outlining whether an introduction or further conversation is appropriate.',
      }),
      Object.freeze({
    ...
    ctaLabel: 'Request private access',
    ctaHref: '/concierge',
    secondaryCtaLabel: 'View private opportunities',
    secondaryCtaHref: '/properties',
  }),
