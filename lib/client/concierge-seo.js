...
const BRAND_NAME = 'Rare & Exclusive Collection';
const TITLE_BASE = 'Private advisory';
const DESCRIPTION_GENERIC =
  'Request a private consultation with Rare & Exclusive Collection — completed residence, development partnership, relocation, investment, or ongoing ownership support in Mauritius. A private advisor responds within one business day.';
...
export function buildConciergeSeo(input) {
  ...
  const description = cleanedPropertyTitle
    ? `Request a private consultation with Rare & Exclusive Collection about ${cleanedPropertyTitle} in Mauritius. A private advisor responds within one business day.`
    : DESCRIPTION_GENERIC;
