...
export const LUX_OPERATOR_FUNCTIONAL_TEST_CHECKLIST = Object.freeze([
  ...
  {
    id: 'confidential_presentation',
    label:
      'After qualification + shortlist, open Confidential Presentation and confirm Viewing by Invitation is the next step.',
    href: '#lux-crm-presentation-panel',
  },
  {
    id: 'viewing_by_invitation',
    label:
      'Open Viewing by Invitation, add format / proposed date-time / access notes, and review the invitation draft (send stays disabled).',
    href: '#lux-crm-viewing-panel',
  },
  {
    id: 'purchase_readiness',
    label:
      'Open Purchase Readiness, capture viewing outcome / buyer intent / readiness, and review the Private Purchase Discussion draft (send stays disabled).',
    href: '#lux-crm-purchase-panel',
  },
  {
    id: 'record_gaps',
