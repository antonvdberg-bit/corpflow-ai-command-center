...
/**
 * Dedicated-daemon-safe sandbox→control-plane URL (overrides image default
 * http://host.docker.internal). Must match compose.yaml; no host-gateway.
 */
export const SANDBOX_LOCAL_RUNTIME_URL = 'http://corpflowai-openhands-app:3000';
