...
export const RAPID_DELIVERY_OFFERS = {
  'ai-lead-rescue': {
    ...
    depositNote:
      '50% deposit in MUR via manual bank transfer (ERPNext invoice) before work; balance on delivery acceptance. Currency and payment instructions are confirmed on the invoice before you pay.',
    clientProvides: [
