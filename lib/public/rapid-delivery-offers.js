...
export const RAPID_DELIVERY_OFFERS = {
  'ai-lead-rescue': {
    ...
    priceIsFixed: true,
    primaryCtaLabel: 'Request a 15-minute diagnosis',
    ...
    metaDescription:
      'Enquiry Recovery Sprint from CorpFlowAI — recover valuable quiet enquiries. MUR 85,000 fixed. Maximum three founding clients. Request a 15-minute diagnosis.',
