...
/** @type {Record<'home'|'contact'|'about'|'process'|'trust'|'services'|'standards'|'onboarding', CorpflowPublicVisualSlot>} */
export const CORPFLOW_PUBLIC_VISUALS = {
  ...
  services: {
    ...
    base: '/assets/visuals/corpflow-services-hero',
    objectPositionDesktop: '70% center',
    objectPositionMobile: '70% center',
  ...
  standards: {
    ...
    base: '/assets/visuals/corpflow-standards-hero',
    objectPositionDesktop: '72% center',
    objectPositionMobile: '72% center',
  ...
  onboarding: {
    ...
    base: '/assets/visuals/corpflow-onboarding-hero',
    objectPositionDesktop: '68% center',
    objectPositionMobile: '68% center',
...
export function buildPublicVisualHero(key, opts = {}) {
  ...
  return {
    ...
    preloadSrcSet: `${base}-768.avif 768w, ${base}.avif 1536w`,
