...
export const CORPflow_PUBLIC_NAV = [
  ...
  { href: '/offers/premium-landing-page-rescue', label: 'Website Rescue' },
...
export const CORPflow_PROOF_ITEMS = [
  ...
  },
  {
    ...
    link: { href: '/offers/premium-landing-page-rescue', label: 'Related product path: Website Rescue' },
  },
  {
