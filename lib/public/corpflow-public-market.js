...
export const CORPflow_HOMEPAGE_HERO = {
  ...
  subhead:
    `${ENQUIRY_RECOVERY_LOSS_LINE} Enquiry Recovery Sprint — ${ENQUIRY_RECOVERY_PRICE_LINE}. ${ENQUIRY_RECOVERY_SCARCITY_LINE} CorpFlowAI does the implementation work from Mauritius.`,
