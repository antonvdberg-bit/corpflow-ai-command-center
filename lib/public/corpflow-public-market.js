...
export const CORPflow_HOMEPAGE_HERO = {
  ...
  subhead:
    `You already paid to generate the enquiry. We help selected owner-led Mauritius businesses identify and recover valuable enquiries that have gone quiet. Enquiry Recovery Sprint — ${ENQUIRY_RECOVERY_PRICE_LINE}. ${ENQUIRY_RECOVERY_SCARCITY_LINE}`,
  primaryCta: { label: 'Request a 15-minute diagnosis', href: ENQUIRY_RECOVERY_DIAGNOSIS_HREF },
  secondaryCta: { label: 'See the Enquiry Recovery Sprint', href: ENQUIRY_RECOVERY_PATH },
};
...
export const OFFER_FAQ_BY_SLUG = {
  ...
  'premium-landing-page-rescue': [
    ...
    { q: 'Can you also fix lead follow-up after the form?', a: 'Yes as a separate Enquiry Recovery engagement — so website scope and follow-up accountability stay clear. Ask during discovery.' },
  ],
...
export const OFFER_NOT_INCLUDED_BY_SLUG = {
  ...
  'premium-landing-page-rescue': [
    ...
    'Enquiry Recovery follow-up work (quoted separately if needed)',
  ],
  'customer-reputation-recovery': [
