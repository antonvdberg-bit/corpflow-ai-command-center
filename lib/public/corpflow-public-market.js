...
/**
 * Gateway/footer product links for the two approved launch products (#700 / #710 / #1127 / #1164).
 * Use buyer-facing names and named landings — not SKU titles or /offers/* URLs —
 * so the CorpFlowAI gateway does not compete with USD 150 Lead Rescue or Website Rescue.
 */
...
export const CORPflow_HOMEPAGE_HERO = {
  eyebrow: 'CorpFlowAI · managed delivery',
  headline: 'Practical AI-assisted workflows for businesses that need work captured, routed, and followed up.',
  subhead:
    'CorpFlowAI designs and operates managed workflow systems using your existing processes and appropriate tools — so owners and managers get a clear operating improvement, not a generic AI demo or a large software rebuild.',
  primaryCta: { label: 'Request a qualified conversation', href: '/contact#discovery' },
  secondaryCta: { label: 'See how we help', href: '#service-paths' },
};
...
export const CORPflow_PROOF_ITEMS = [
  {
    ...
    link: { href: '/lead-rescue', label: 'Related product path: AI Lead Rescue' },
  },
  {
