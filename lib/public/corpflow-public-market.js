...
export const CORPflow_PROOF_ITEMS = [
  ...
  },
  {
    ...
    capability:
      'Qualified intake, status tracking, and operator review for lead and service workflows — including controlled desk surfaces used in CorpFlowAI test delivery (for example Business Admin Desk-style operational UI patterns).',
    demonstratedBy: 'Internal / test tenant capability (Business Admin Desk and operator desks)',
...
export const OFFER_NOT_INCLUDED_BY_SLUG = {
  ...
  'premium-landing-page-rescue': [
    ...
    'Lead Rescue follow-up work (quoted separately if needed)',
  ],
  'customer-reputation-recovery': [
