/**
 * Buyer-facing source of truth for the live Enquiry Recovery Sprint.
 * Do not treat historic USD 150 / MUR 35,000 copy as current commercial terms.
 */

export const ENQUIRY_RECOVERY_PATH = '/enquiry-recovery';
...
export const ENQUIRY_RECOVERY_OFFER_NAME = 'Enquiry Recovery Sprint';
...
export const ENQUIRY_RECOVERY_SCARCITY_LINE =
  'We are accepting a maximum of three founding clients during this delivery cycle.';
...
export const ENQUIRY_RECOVERY_PRIMARY_CTA_LABEL = 'Request a 15-minute Enquiry Recovery Diagnosis';
