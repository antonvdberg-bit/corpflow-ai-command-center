/**
 * Business Admin Desk — Beneficial Ownership specialist-review surface content (#981).
 *
...
export function buildCipcDeskBeneficialOwnershipReviewContent() {
  return {
    ...
    meta: {
      page_title: 'Business Admin Desk · Beneficial Ownership review',
      description:
    ...
    banners: {
      ...
      independence:
        'Business Admin Desk is an independent support service. It is not CIPC, is not endorsed by CIPC, and must never imply official affiliation.',
      no_guarantee:
        'Turnaround times, filing outcomes, and beneficial-owner determinations are not guaranteed. Business Admin Desk does not decide who a beneficial owner is. Any estimate is subject to CIPC processing times, system availability, submission quality, reviewer requests, and manual review.',
      provisional:
    ...
    official_windows: {
      ...
      items: [
        ...
        'Never convert those windows into a Business Admin Desk turnaround or outcome guarantee.',
      ],
    },
    open_questions: {
    ...
    sarah_review: {
      ...
      instructions: [
        ...
        'Submit structured feedback at the bottom of this page. It uses the existing Business Admin Desk email-intake path and stores a synthetic ticket for tenant cipc-desk.',
    ...
    feedback_prompt: {
      ...
      intro:
        'Submit feedback through the existing Business Admin Desk email-intake path. It stores a synthetic CMP ticket for tenant cipc-desk in the existing Postgres — no new schema, CRM, or email-send runtime.',
      fields: [
...
export function buildBeneficialOwnershipReviewFeedbackEmail(fields = {}) {
  ...
  const lines = [
    ...
    '',
    'Synthetic / specialist review feedback for the Business Admin Desk Beneficial Ownership corpflow_test surface (#981).',
