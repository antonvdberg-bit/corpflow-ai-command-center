/**
 * Business Admin Desk — Director Changes specialist-review surface content (#980).
 *
...
export function buildCipcDeskDirectorChangesReviewContent() {
  return {
    ...
    meta: {
      page_title: 'Business Admin Desk · Director Changes review',
      description:
    ...
    feedback_prompt: {
      ...
      intro:
        'Submit feedback through the existing Business Admin Desk email-intake path. It stores a synthetic CMP ticket for tenant cipc-desk in the existing Postgres — no new schema, CRM, or email-send runtime. Use this to confirm or reject the open questions above.',
      fields: [
...
export function buildDirectorChangesReviewFeedbackEmail(fields = {}) {
  ...
  const lines = [
    ...
    '',
    'Synthetic / specialist review feedback for the Business Admin Desk Director Changes corpflow_test surface (#980).',
