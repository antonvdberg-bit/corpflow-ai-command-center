/**
 * Business Admin Desk — conversion-focused commercial partner funnel (#986).
 *
...
export const CIPC_DESK_PARTNER_ENQUIRY_SUBJECT = 'Business Admin Desk · Partner overflow / white-label enquiry';
...
export function buildCipcDeskPartnerFunnelContent() {
  return {
    ...
    meta: {
      page_title: 'Business Admin Desk · Partner support for accounting firms',
      description:
        'Business Admin Desk provides fractional and white-label company-administration support for South African accounting, tax and advisory firms.',
      robots: 'noindex,nofollow',
    },
    nav: {
      brand: 'Business Admin Desk',
    ...
    hero: {
      ...
      subhead:
        'White-label / fractional support for company administration, statutory records, beneficial ownership, director/shareholder changes, resolutions and governance administration.',
      primary_cta: {
    ...
    audience: {
      ...
      not_for:
        'If you need help with your own company’s filing, use the direct company-administration desk instead of this partner path.',
      not_for_href: '/',
      not_for_cta: 'Go to the company-administration desk',
    },
    problem: {
    ...
    proof: {
      ...
      items: [
        ...
        },
        {
          ...
          detail:
            'Company administration, registers, beneficial ownership, director and shareholder changes, resolutions, minutes, and compliance calendars.',
        },
        {
    ...
    trust: {
      ...
      items: [
        'Independent support — not a government or regulatory service, and not a law firm.',
        'No government or regulatory affiliation or endorsement is implied.',
        'Filing outcomes, turnaround, and regulatory processing times are not guaranteed.',
    ...
    faqs: {
      ...
      items: [
        ...
        {
          q: 'Is this just a commodity filing service?',
    ...
    form: {
      ...
      confirmation:
        'Thank you. We will reply using the contact details you provided, usually within one business day, on your preferred channel. This enquiry is not a filing instruction and does not start filing work until scope is agreed.',
    ...
    footer: {
      independence:
        'Independent company-secretarial support. Not a government or regulatory service, and not a law firm. Filing outcomes are not guaranteed.',
