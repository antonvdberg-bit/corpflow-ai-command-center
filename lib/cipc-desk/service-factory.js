...
export function draftCipcMissingInformationRequest(matter) {
  ...
  return [
    ...
    lines,
    'Business Admin Desk cannot guarantee CIPC timing or acceptance. No identity documents should be pasted into GitHub.',
  ].join('\n');
}
...
export function draftCipcClientStatusUpdate(matter) {
  ...
  return [
    ...
    'Business Admin Desk is not CIPC and does not guarantee outcomes.',
  ].join(' ');
}
