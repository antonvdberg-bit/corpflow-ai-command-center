/**
 * Business Admin Desk — Annual Returns specialist-review surface content (#761 / #791).
 *
...
export function buildCipcDeskAnnualReturnsReviewContent() {
  return {
    ...
    meta: {
      page_title: 'Business Admin Desk · Annual Returns review',
      description:
    ...
    feedback_prompt: {
      ...
      intro:
        'Submit feedback through the existing Business Admin Desk email-intake path. It stores a synthetic CMP ticket for tenant cipc-desk in the existing Postgres — no new schema, CRM, or email-send runtime. Use this if a genuinely new ambiguity appears after the 2026-08-07 decisions.',
      fields: [
...
export function buildAnnualReturnsReviewFeedbackEmail(fields = {}) {
  ...
  const lines = [
    ...
    '',
    'Synthetic / specialist review feedback for the Business Admin Desk Annual Returns corpflow_test surface (#791).',
