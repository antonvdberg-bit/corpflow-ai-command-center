...
export const FACTORY_CONTROL_PLANE_V1 = Object.freeze({
  ...
  components: Object.freeze([
    ...
    Object.freeze({
      ...
      phase1: 'introduce-repo-only',
      notes: 'Durable wait/signal/resume + allow-listed next action. Live worker is an exact protected L3 action.',
    }),
  ]),
});
...
export function phase1ResourceSnapshot() {
  return {
    ...
    note: 'Phase 1 is repo-only. Live host snapshot remains the #1025 POC baseline until the L3 worker is separately approved.',
  };
}
