...
export const CURSOR_EXECUTION_TIER_MODELS = Object.freeze({
  low: Object.freeze({
    // Exact Cloud Agents API model and parameter IDs from GET /v1/models.
    // `reasoning`, rather than the stale UI-era `effort`, selects the
    // economical non-Fast Terra variant.
    id: 'gpt-5.6-terra',
    params: Object.freeze([{ id: 'reasoning', value: 'medium' }, { id: 'fast', value: 'false' }]),
  }),
