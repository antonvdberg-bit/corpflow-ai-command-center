...
export const CURSOR_EXECUTION_TIER_MODELS = Object.freeze({
  low: Object.freeze({
    // The Cloud Agents API ID returned by GET /v1/models. “GPT-5.6 Terra
    // Medium” is a specific `effort=medium` variant, not an API identifier.
    // Deliberately no Fast parameter: the measured non-Fast selection is the
    // economical default.
    id: 'gpt-5.6-terra',
    params: Object.freeze([{ id: 'effort', value: 'medium' }]),
  }),
  medium: Object.freeze({
    // Stronger current GPT-5.6 option. MEDIUM remains subject to durable
    // controller justification; it is not a fallback after a LOW failure.
