...
export const CURSOR_EXECUTION_TIER_MODELS = Object.freeze({
  low: Object.freeze({
    id: 'gpt-5.4',
    params: Object.freeze([{ id: 'reasoning', value: 'low' }]),
  }),
  medium: Object.freeze({
    id: 'gpt-5.4',
    params: Object.freeze([{ id: 'reasoning', value: 'medium' }]),
  }),
  high: Object.freeze({
    id: 'gpt-5.4',
    params: Object.freeze([{ id: 'reasoning', value: 'high' }]),
  }),
});

const AUTHORIZED_TIER_EVIDENCE_ACTORS = new Set(['antonvdberg-bit', 'github-actions[bot]']);
