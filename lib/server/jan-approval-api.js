...
function bridgeIdentity(deps = {}) {
  if (Object.prototype.hasOwnProperty.call(deps, 'bridgeIdentity')) return str(deps.bridgeIdentity).toLowerCase();
  try {
...
function decisionSigningKey(deps = {}) {
  const serverSecret = str(
    Object.prototype.hasOwnProperty.call(deps, 'decisionSigningKey')
      ? deps.decisionSigningKey
      : getSessionSecret(),
  );
