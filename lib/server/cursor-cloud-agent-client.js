 ...
 * @returns {{ itemCount: number, items: Array<{ id: string, displayName: string | null, aliases: string[], parameterIds: string[], variantCount: number }> }}
 */
export function summarizeCursorModelCatalog(modelCatalog) {
