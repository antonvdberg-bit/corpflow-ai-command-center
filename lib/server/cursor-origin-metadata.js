...
export function resolveCursorOriginMetadata(input = {}) {
  ...
  // Run/agent heuristics must be restricted to actual origin evidence. Before
  // #862 repair, a factory capacity packet on #882 that mentioned #881's run
  // was enough to make #882 consume a second WIP slot with the same run id.
