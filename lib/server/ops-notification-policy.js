 ...
 * required now. Slack is retired and CI-guarded — see
 * docs/operations/SLACK_TELEGRAM_DEPENDENCY_AUDIT_658.md and
...
/** Approved operator notification surfaces after issue #658. Slack is not among them. */
export const APPROVED_OPS_NOTIFICATION_CHANNELS = Object.freeze(['github', 'telegram']);

/** Channels that must not be reintroduced as CorpFlow ops notification paths. */
export const FORBIDDEN_OPS_NOTIFICATION_CHANNELS = Object.freeze(['slack']);
