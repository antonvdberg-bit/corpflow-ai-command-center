  ...
  return {
    en: {
      ...
      guide: {
        ...
        step2_h: 'Step 2 — Request changes (Change Console)',
        step2_p: 'The Change Console is where you tell us what you want. Example requests:',
        ...
        login_h: 'Login details',
        login_p: 'If you were given a PIN, you can log in here:',
        login_btn: 'Open login page',
        login_tip:
          'Choose Tenant login and enter your PIN. If you don’t have it yet, reply to the onboarding email and we will issue it.',
    ...
    fr: {
      ...
      guide: {
        ...
        step2_h: 'Étape 2 — Demander des modifications (Change Console)',
        step2_p: 'La Change Console sert à décrire vos demandes. Exemples :',
        ...
        login_h: 'Connexion',
        login_p: 'Si vous avez reçu un code PIN :',
        login_btn: 'Ouvrir la page de connexion',
        login_tip:
          'Choisissez la connexion locataire et saisissez votre PIN. Sinon, répondez à l’e-mail d’onboarding.',
    ...
    ru: {
      ...
      guide: {
        ...
        step2_h: 'Шаг 2 — Запрос изменений (Change Console)',
        step2_p: 'В Change Console вы описываете, что нужно изменить. Примеры:',
        ...
        login_h: 'Вход',
        login_p: 'Если вам выдали PIN:',
        login_btn: 'Открыть страницу входа',
        login_tip:
          'Выберите вход арендатора и введите PIN. Если PIN нет — ответьте на письмо онбординга.',
...
export function defaultPublicSite(tenantId, host) {
  const brand = tenantId ? str(tenantId).replace(/[-_]+/g, ' ') : 'CorpFlow';
  return {
    tenant_id: tenantId || null,
    host: host || null,
    meta: {
      page_title: 'Lux Mauritius · Preview',
      ...
      guide_title: 'Lux Mauritius · How to request changes',
    },
    languages: ['en', 'fr', 'ru'],
    lang_default: 'en',
    i18n: defaultLuxI18n(),
