...
export const CIPC_DESK_WEBSITE_DRAFT_VERSION = 'cipc-desk-website-draft-v5-director-changes-link';
      ...
      routes: {
        ...
        items: [
          ...
          },
          {
            ...
            detail:
              'Referred or batch matters for your clients. Include your firm name, client company identifiers, and what you need Serah to handle versus what you retain.',
      ...
      services: {
        ...
        items: [
          ...
          },
          {
            ...
            detail: 'Confirm natural-person owners/controllers and supporting IDs before any annual-return hard-stop risk.',
          },
          {
