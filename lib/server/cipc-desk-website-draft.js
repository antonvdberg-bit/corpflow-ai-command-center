/**
 * Business Admin Desk standing corpflow_test website draft (fictional / provisional).
...
export const CIPC_DESK_WEBSITE_DRAFT_VERSION =
  'cipc-desk-website-draft-v8-director-changes-beneficial-ownership-link-partner-funnel-business-admin-desk-brand';
...
export function buildCipcDeskWebsiteDraft() {
  const seedNote =
    'Internal corpflow_test surface — fictional example only. Service requirements, documents, turnaround and pricing must be validated by Serah Fourie before any client work. Independent company-administration support; not a government or regulatory service, not a law firm, and not an authorised government representative.';
  ...
  return {
    ...
    meta: {
      page_title: 'Business Admin Desk · Company administration support',
      console_heading: 'Business Admin Desk · Change Console',
      guide_title: 'Business Admin Desk · How to request a service',
      surface_label: 'Business Admin Desk',
      description:
    ...
    hero: {
      title: 'Business Admin Desk',
      headline: 'Clear company administration — handled with care',
      tagline:
        'Professional South African company-administration support for registrations, director changes, registered-address changes, annual returns, beneficial ownership, amendments, records and ongoing administration.',
      cta_label: 'Tell us what you need help with',
      cta_href: mailto('Business Admin Desk · Direct SME enquiry'),
        ...
        items: [
          {
            ...
            detail:
              'Company registration, director changes, annual returns, beneficial ownership, address changes, and ongoing company-administration support for the company itself.',
      ...
      services: {
        ...
        items: [
          ...
          },
          {
            ...
            detail:
              'Appointment, resignation, and director particulars. Death/removal stay specialist exceptions. Specialist review surface: /director-changes (corpflow_test).',
            href: '/director-changes',
          },
          {
          ...
          },
          {
            name: 'Annual returns',
            detail:
              'Confirm turnover band, beneficial-ownership status, and timing. Official filing fees are separate from any service fee. Specialist review surface: /annual-returns (corpflow_test).',
            href: '/annual-returns',
          },
          {
          ...
          {
            name: 'Monthly company-administration support',
