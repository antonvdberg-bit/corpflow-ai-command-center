...
export const CIPC_DESK_WEBSITE_DRAFT_VERSION =
  'cipc-desk-website-draft-v8-direct-sme-company-funnel';
...
export function buildCipcDeskWebsiteDraft() {
  ...
  return {
    ...
    hero: {
      ...
      cta_label: 'Request company-secretarial help',
      cta_href: '/company',
        ...
        items: [
          {
            ...
            detail:
              'Company registration, director changes, annual returns, beneficial ownership, address changes, and ongoing CIPC administration support for the company itself. This is not the specialist-review workspace.',
            cta_label: 'Request company-secretarial help',
            cta_href: '/company',
          },
          {
      ...
      services: {
        ...
        items: [
          ...
          },
          {
            ...
            detail:
              'Appointment, resignation, and director particulars. Death/removal stay specialist exceptions. Request this help on the company enquiry page — not the internal review workspace.',
            href: '/company',
          },
          {
          ...
          },
          {
            name: 'Annual returns',
            detail:
              'Confirm turnover band, beneficial-ownership status, and timing. Official CIPC fees are separate from any service fee. Request this help on the company enquiry page — not the internal review workspace.',
            href: '/company',
          },
          {
            name: 'Beneficial ownership submissions',
            detail:
              'Confirm natural-person owners/controllers and supporting items for the common path. Trusts, juristic persons, foreign ownership, and layered control escalate to specialist review. Request this help on the company enquiry page — not the internal review workspace.',
            href: '/company',
          },
          {
