...
export const CIPC_DESK_WEBSITE_DRAFT_VERSION = 'cipc-desk-website-draft-v3-corpflow-visual';
    ...
    sections: {
      ...
      services: {
        ...
        items: [
          ...
          {
            name: 'Annual returns',
            detail: 'Confirm turnover band, beneficial-ownership status, and timing. Official CIPC fees are separate from any service fee.',
          },
          {
