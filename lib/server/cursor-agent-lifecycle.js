...
export async function runCursorAgentLifecycleTick(input) {
  ...
  const progressChanged =
    !prior.progressFingerprint || prior.progressFingerprint !== progressFingerprint;
  const lastProgressAt = progressChanged
    ? nowIso
    : prior.lastProgressAt || prior.startedAt || startedAt;
  actions.push(progressChanged ? 'observable_progress_changed' : 'observable_progress_unchanged');
