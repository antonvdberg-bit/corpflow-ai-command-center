...
import { DEFAULT_CLIENT_DECISION_THANK_YOU } from './client-decisions-client.js';

export const CLIENT_DECISIONS_ACCESS_KEY = 'client_decisions_access';

/** Shown after magic-link submit or when revisiting a consumed / complete link (default programme set). */
export const THANK_YOU_CLIENT_DECISIONS_MAGIC = DEFAULT_CLIENT_DECISION_THANK_YOU;
