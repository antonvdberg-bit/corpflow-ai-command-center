...
export const AI_LEAD_RESCUE_SETUP_CHECKLIST_V1 = Object.freeze([
  {
    key: 'kickoff_call_held',
    label: 'Kickoff call with client booked and held',
    hint: 'Confirm scope, owner/operator, channels, and 48-hour window.',
  },
  {
    key: 'lead_source_connected',
    label: 'Lead source connected (form / email / WhatsApp / Google Form)',
    hint: 'Confirm the one source the client already uses.',
  },
  {
    key: 'owner_alert_configured',
    label: 'Owner / operator alert wired and tested',
    hint: 'Test with a real enquiry; confirm the alert reaches the right person.',
  },
  {
    key: 'lead_log_ready',
    label: 'Lead log created and shared with client',
    hint: 'Google Sheet or equivalent; columns: date, name, contact, source, status.',
  },
  {
    key: 'follow_up_board_ready',
    label: 'Follow-up board configured',
    hint: 'New / Replied / Booked / Won / Lost — minimum viable kanban.',
  },
  {
    key: 'daily_summary_scheduled',
    label: 'Daily lead summary scheduled',
    hint: 'Confirm channel (email / WhatsApp), time zone, and recipient.',
  },
  {
    key: 'pilot_monitoring_active',
    label: 'Pilot monitoring active (7 days)',
    hint: 'Owner aware of how to flag issues; CorpFlow watching alerts daily.',
  },
  {
    key: 'client_handover_done',
