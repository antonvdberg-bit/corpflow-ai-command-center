 ...
 * (always `shouldTransform: false` / `source: original` until 5C). Optional strict **`width=`** on the public route
 * keys caches only; responses remain **original bytes**.
 *
 * NOT in scope here:
...
/**
 * Phase 5B transform plan — execution stub for 5C/CDN (`shouldTransform` stays false in this phase).
 *
