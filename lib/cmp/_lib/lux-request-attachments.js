 ...
 * @param {unknown} consoleJson
 * @param {string} attachmentId
 * @param {{ property_slug: string, intended_slot: string, published_by?: string | null, published_at?: string | null, public_caption?: string | null, public_alt_text?: string | null }} args
 * @returns {{ ok: true, consoleJson: object, entry: object, link: object } | { ok: false, error: string }}
 */
