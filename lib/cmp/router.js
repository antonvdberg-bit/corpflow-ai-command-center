...
async function handleLuxLeadOperatorPatch(req, res) {
  ...
  if (
    ...
    return res.status(400).json({
      error: 'NO_UPDATES',
      hint:
        'Provide stage, note, follow_up_status, assign_owner, next_action_at, next_action_note, private_client_qualification, shortlist_slugs, invitation_operator_note, presentation_notes, and/or viewing_next_step.',
    });
  }
