...
/** #772 / #1006 / #1004 / #1005 / #1119 / #1140 / #1159 / #1160 / #1184 — Operating / Tenant Workspace chrome + Prospect Operations + Today / My Work + shared detail + workbench + Pipeline + Action Queue + Clients + Tenant simplification + Commercial + Delivery + action overview + ERPNext quotation evidence + ERPNext Project/Issue continuity. */
export const APP_WORKSPACE_SLICE_VERSION = 'workspace-1184-v1';

/** #1073 — Tenant request / review / /change continuity. */
export const APP_TENANT_JOURNEY_VERSION = 'tenant-journey-1073-v1';

/** #1151 / #1165 — tenant-safe Website Rescue delivery progress in Requests & Progress. */
export const APP_WEBSITE_RESCUE_TENANT_PROGRESS_VERSION = 'website-rescue-tenant-progress-1151-v1';

/**
 * Synthetic authorised Website Rescue prospect used for the tenant progress journey.
 * Identity is the existing lead id (no copied cmp_tickets row).
 */
export const WEBSITE_RESCUE_TENANT_PROGRESS_REQUEST_ID = 'syn-1151-wr-tenant-progress';

/** Isolation foil — Website Rescue delivery bound to another tenant. */
export const WEBSITE_RESCUE_TENANT_PROGRESS_FOIL_ID = 'syn-1151-wr-other-tenant';
...
/**
 * #1155 / #1165 — Tenant Workspace request bound to the existing Lead Rescue
 * onboarding/delivery record (`synthetic-lr-client-review`). Same tenant
 * identity as other CorpFlowAI fixture requests — not a second CRM.
 */
export const LEAD_RESCUE_TENANT_REQUEST_ID = 'syn_lr_delivery_corpflowai_001';
...
export const CORE_NAV_ITEMS = Object.freeze([
  Object.freeze({ id: 'overview', label: 'Overview', href: '/app/core' }),
  ...
  Object.freeze({ id: 'requests', label: 'Requests', href: '/app/core?view=requests' }),
  Object.freeze({ id: 'prospects', label: 'Prospects', href: '/app/prospects' }),
  Object.freeze({ id: 'clients', label: 'Clients', href: '/app/clients' }),
  Object.freeze({ id: 'commercial', label: 'Commercial', href: '/app/commercial' }),
