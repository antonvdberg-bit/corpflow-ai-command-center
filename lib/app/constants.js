...
/** #772 / #1006 / #1004 / #1005 / #1119 / #1140 — Operating / Tenant Workspace chrome + Prospect Operations + Today / My Work + shared detail + workbench + Pipeline + Action Queue + Clients + Tenant simplification + Commercial + Delivery. */
export const APP_WORKSPACE_SLICE_VERSION = 'workspace-1140-v1';

/** #1073 — Tenant request / review / /change continuity. */
export const APP_TENANT_JOURNEY_VERSION = 'tenant-journey-1073-v1';

/** #1151 — tenant-safe Website Rescue delivery progress in Requests & Progress. */
