...
/** #772 / #1074 — Operating Workspace chrome + Prospect Operations + Today / Workbench / Pipeline / Queue / Clients + legacy-route retirement wave 1. */
export const APP_WORKSPACE_SLICE_VERSION = 'workspace-1074-v1';
...
export const CORE_NAV_ITEMS = Object.freeze([
  ...
  Object.freeze({ id: 'delivery', label: 'Delivery', href: '/change' }),
...
/** Tenant navigation — may link to existing enabled capabilities. */
export const TENANT_NAV_ITEMS = Object.freeze([
  Object.freeze({ id: 'home', label: 'Home / Overview', href: null }),
  Object.freeze({ id: 'my_work', label: 'My Work', href: null }),
  Object.freeze({ id: 'requests_progress', label: 'Requests & Progress', href: null }),
  Object.freeze({ id: 'documents', label: 'Documents', href: null }),
  Object.freeze({ id: 'reports', label: 'Reports', href: null }),
  Object.freeze({ id: 'support', label: 'Support', href: null }),
]);
...
export const COMPATIBILITY_ROUTES = Object.freeze([
  Object.freeze({
    path: '/change',
    role: 'compatibility',
    note: 'Change Console remains operational hub; not expanded into /app shell.',
  }),
  Object.freeze({
    path: '/change-v2',
    role: 'experimental',
  ...
  Object.freeze({
    path: '/change/revenue',
    role: 'retired_notice',
    note: '#1074: localStorage pipeline removed. Retirement notice only. Canonical pipeline is /app/pipeline (Core).',
  }),
  Object.freeze({
    path: '/admin/rapid-delivery',
    role: 'redirected',
    note: '#1074: admin-gated redirect to /app/queue.',
  }),
  Object.freeze({
    path: '/admin/lead-rescue',
    role: 'redirected',
    note: '#1074: admin-gated redirect to /app/workbench?filter=lead_rescue.',
  }),
]);
