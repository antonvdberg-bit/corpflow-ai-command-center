...
/** #772 / #1040 — Operating / Tenant Workspace chrome + Prospect Operations + Today + Queue + Workbench + Pipeline. */
export const APP_WORKSPACE_SLICE_VERSION = 'workspace-1040-v1';
...
export const CORE_NAV_ITEMS = Object.freeze([
  ...
  Object.freeze({ id: 'queue', label: 'Queue', href: '/app/queue' }),
