...
/** #772 / #1006 — Operating / Tenant Workspace chrome + Prospect Operations + Today / My Work + shared detail + workbench + Pipeline + Action Queue + Tenant simplification. */
export const APP_WORKSPACE_SLICE_VERSION = 'workspace-1006-v1';
...
/**
 * Tenant navigation — client request / review / progress only (#1006).
 * Internal Core / Operating Workspace items are not listed.
 * /change is the existing tenant service surface (not a new page).
 */
export const TENANT_NAV_ITEMS = Object.freeze([
  Object.freeze({ id: 'requests_progress', label: 'Requests & Progress', href: null }),
  Object.freeze({ id: 'service_change', label: 'Service & change', href: '/change' }),
]);
