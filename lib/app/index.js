/**
 * #778 / #877 — Core/Tenant app foundation (production-shaped request adapters + read-only cmp_tickets).
 * Slice 2: authenticated live request workspace on the normal session path.
 */
