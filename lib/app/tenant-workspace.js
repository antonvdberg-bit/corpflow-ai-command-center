...
export const TENANT_WORKSPACE_ROUTE_MATRIX = Object.freeze([
  ...
  Object.freeze({
    ...
    disposition: 'STAFF_ONLY_FAIL_CLOSED',
    reason: 'Not a tenant route. Unimplemented staff surface; tenant must not operate it.',
  }),
  Object.freeze({
    path_or_nav: '/app/delivery',
    name: 'Delivery (staff)',
    disposition: 'STAFF_ONLY_FAIL_CLOSED',
    reason: 'Not a tenant route. Core delivery stays on staff /change; tenant uses Service & change.',
  }),
]);
...
/**
 * Conceptual staff desks named in #773 / #1120 that tenants must not operate.
 * These routes are not Tenant Workspace pages; 404 or 403 is fail-closed.
 *
 * @type {readonly string[]}
 */
export const STAFF_ONLY_UNIMPLEMENTED_PATHS = Object.freeze(['/app/commercial', '/app/delivery']);
