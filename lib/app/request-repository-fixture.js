 ...
 * Mutations persist in the in-memory fixture store (same AppRequest contract).
 */
...
export function createFixtureRequestRepository() {
  ...
  return {
    ...
    persistencePath: 'fixture_store.console_json',
    ...
    async updateRequest(requestId, mutator, _opts = {}) {
      writeAttempts += 1;
