...
export function fixtureProspectLeadRows(now = new Date()) {
  ...
  return [
    ...
    },
    {
      ...
      status: 'NEW',
      createdAt: new Date('2026-08-20T08:00:00.000Z'),
      updatedAt: new Date('2026-08-26T04:11:21.000Z'),
      qualificationJson: {
        intake_meta: {
          product: RAPID_DELIVERY_PRODUCT,
          business_name: 'CF1018 Synthetic Sales Lifecycle Ltd',
          offer_slug: 'premium-landing-page-rescue',
          service_path: 'website-digital',
          primary_pain: 'Need a recorded MUR quotation before financial clearance',
        ...
        rapid_delivery_operator: {
          status: 'quote_ready',
          owner: 'anton',
          next_action: 'Record acceptance and payment evidence on the commercial rail',
          notes:
            'Existing ERPNext MUR quotation SAL-QTN-2026-00005 is recorded. Financial clearance is still fail-closed.',
          activity: [],
          updated_at: '2026-08-26T04:11:21.000Z',
        },
        erpnext: {
          schema: 'corpflow.qualification.erpnext.v1',
          bridge: 'lead_opportunity_promotion',
          quotation_bridge: 'quotation_invoice',
          ...
          quotation_idempotency_key: 'corpflow.selling_q2c.v1:lead=cf1018-synthetic-sales-lifecycle',
        },
        commercial_approval: {
          product: 'website-rescue',
          opportunity_ref: 'cf1018-synthetic-sales-lifecycle',
          prospect_ref: 'cf1018-synthetic-sales-lifecycle',
          proposal_status: 'operator_reviewed',
          proposal_version: 'SAL-QTN-2026-00005',
          quoted_currency: 'MUR',
          setup_price: 45000,
          offer_kind: 't1_one_page',
          payment_terms: 'deposit_50_balance_before_production',
          scope_summary:
            'Website Rescue landing-page rescue for CF1018 Synthetic Sales Lifecycle Ltd. Existing ERPNext draft Quotation SAL-QTN-2026-00005 (MUR 45,000). Synthetic proof only — no send, no Sales Invoice posting, no Payment Entry.',
          erpnext_quotation: 'SAL-QTN-2026-00005',
          ...
          won_lost_status: 'open',
          commercial_notes:
            'Quotation reference recorded. Do not infer payment, acceptance, tax, or accounting status from the ERPNext draft. Proceed Approved stays fail-closed until #714 evidence is complete.',
          proposal: {
            status: 'operator_reviewed',
    ...
    },
    {
      ...
      qualificationJson: {
        ...
        commercial_approval: {
          ...
          proposal_status: 'operator_reviewed',
          proposal_version: 'WR-T1-SYN-1151',
          quoted_currency: 'MUR',
          setup_price: 45000,
          offer_kind: 't1_one_page',
          payment_terms: 'full_upfront',
