...
export const TENANT_ROUTE_NAV_MATRIX = Object.freeze([
  ...
  Object.freeze({
    ...
    reason: 'Staff commercial surface. Not a tenant route; tenant must not operate it.',
  }),
  Object.freeze({
    ...
    nav_label: null,
    disposition: 'STAFF_ONLY_FAIL_CLOSED',
    reason: 'Staff delivery surface. Tenant service path remains canonical /change.',
  }),
]);
