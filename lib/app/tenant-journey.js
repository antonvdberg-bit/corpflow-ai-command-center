...
export const TENANT_ROUTE_NAV_MATRIX = Object.freeze([
  ...
  Object.freeze({
    ...
    reason: 'Operating Workspace action overview. Tenant session must 403.',
  }),
  Object.freeze({
    id: 'operating_overview_api',
    path: '/api/app/overview',
    nav_label: null,
    disposition: 'STAFF_ONLY_FAIL_CLOSED',
    reason: 'Operating Workspace action overview API. Tenant session must 403.',
  }),
  Object.freeze({
    id: 'operating_today',
    path: '/app/today',
  ...
  Object.freeze({
    ...
    nav_label: null,
    disposition: 'STAFF_ONLY_FAIL_CLOSED',
    reason: 'Delivery summary. Tenant session must 403.',
  }),
]);
...
export function isStaffOnlyTenantDeniedPath(path) {
  ...
  if (p === '/app/commercial' || p === '/api/app/commercial') return true;
  if (p.startsWith('/app/commercial/')) return true;
  if (p === '/api/app/commercial-quotation' || p === '/api/app/commercial-quotation-pdf') return true;
  if (p === '/api/app/commercial/quotation' || p === '/api/app/commercial/quotation-pdf') return true;
  if (p === '/app/delivery' || p === '/api/app/delivery') return true;
  if (p === '/api/app/overview') return true;
