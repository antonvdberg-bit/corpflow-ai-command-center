...
export const WORKSPACE_SURFACE_MATRIX = Object.freeze([
  ...
  Object.freeze({
    ...
    disposition: 'CANONICAL',
    notes: 'Canonical tenant service/change/tickets. Tenant Workspace hands off with from=tenant-workspace. Do not promote whole tree into Operating Workspace. Navigation does not create a ticket.',
  }),
  Object.freeze({
