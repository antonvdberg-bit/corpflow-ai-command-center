...
/** @typedef {'CANONICAL'|'REUSE'|'MIGRATE'|'TEMPORARY'|'RETIRE'|'REDIRECT'} SurfaceDisposition */
...
export const WORKSPACE_SURFACE_MATRIX = Object.freeze([
  Object.freeze({
    ...
    notes: 'Deliberate entry; separate Core vs Tenant auth; no shared switcher.',
  }),
  Object.freeze({
    path: '/app/core',
  ...
  Object.freeze({
    ...
    data_source: 'fixture | cmp_tickets_read',
    disposition: 'CANONICAL',
    notes: 'Existing #778/#877 shell. CorpFlowAI uses normal tenant auth.',
  }),
  Object.freeze({
    path: '/app/prospects',
  ...
  Object.freeze({
    ...
    disposition: 'CANONICAL',
    notes: 'Staff-only #994 slice. Same Lead Rescue and Website Rescue rows. Holds extracted checklist, activity, and proposal-summary contracts (#1074).',
  }),
  Object.freeze({
    path: '/app/workbench',
    ...
    data_source: 'fixture | leads_read + existing qualificationJson write paths',
    disposition: 'CANONICAL',
    notes: 'Staff-only #996. Cross-product processing grid. Opens #994 shared detail. /admin/lead-rescue redirects here (filter=lead_rescue).',
  }),
  Object.freeze({
    path: '/app/queue',
    ...
    disposition: 'CANONICAL',
    notes: 'Staff-only #995. Cross-product queue. Opens #994 shared detail. /admin/rapid-delivery redirects here.',
  }),
  Object.freeze({
    path: '/app/pipeline',
  ...
  Object.freeze({
    ...
    name: 'Legacy Rapid Delivery desk',
    environment: 'core',
    record_type: 'leads (corpflow-rapid-delivery)',
    data_source: 'Postgres leads via admin-rapid-delivery-api (APIs retained)',
    disposition: 'REDIRECT',
    notes: 'Wave 1 (#1074): admin session → /app/queue. Proposal summary lives on shared detail.',
  }),
  Object.freeze({
    path: '/admin/lead-rescue',
    name: 'Legacy Lead Rescue workbench list',
    environment: 'core',
    record_type: 'leads (ai-lead-rescue)',
    data_source: 'Postgres leads via admin-lead-rescue-api (APIs retained)',
    disposition: 'REDIRECT',
    notes: 'Wave 1 (#1074): admin session → /app/workbench?filter=lead_rescue.',
  }),
  Object.freeze({
    path: '/admin/lead-rescue/[id]',
    name: 'Legacy Lead Rescue workbench detail',
    environment: 'core',
    record_type: 'leads (ai-lead-rescue)',
    data_source: 'Postgres leads via admin-lead-rescue-api (APIs retained)',
    disposition: 'REDIRECT',
    notes: 'Wave 1 (#1074): admin session → /app/prospects/[id]. Checklist + activity extracted.',
  }),
  Object.freeze({
    path: '/change/revenue',
    name: 'Retired revenue cockpit (notice)',
    environment: 'mixed',
    record_type: 'none (no localStorage pipeline)',
    data_source: 'retirement notice; canonical pipeline is /app/pipeline',
    disposition: 'RETIRE',
    notes: 'Wave 1 (#1074): localStorage Kanban removed. Notice only — mixed auth cannot hard-redirect into Core /app/pipeline.',
  }),
  Object.freeze({
    path: '/change',
    name: 'Change Console',
    ...
    disposition: 'CANONICAL',
    notes: 'Tenant service/change/tickets. Do not promote whole tree into Operating Workspace.',
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    disposition: 'REUSE',
    notes: 'Evidence/asset editor. Canonical operator Clients summary is /app/clients (#999). Do not retire this desk in this slice.',
  }),
]);
 ...
 * Tenant My Work remains an in-shell placeholder (later Tenant simplification slice).
 * @returns {boolean}
 */
