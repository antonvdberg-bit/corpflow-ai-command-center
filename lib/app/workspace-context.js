...
export function isProspectOperationsPath(path) {
  ...
  return p === PROSPECT_OPERATIONS_PATH || p === '/api/app/prospects';
}
...
export const WORKSPACE_SURFACE_MATRIX = Object.freeze([
  ...
  Object.freeze({
    ...
    disposition: 'CANONICAL',
    notes: 'Staff-only. Reuses #721 view-model. Not shown in Tenant nav.',
  }),
  Object.freeze({
    path: '/app/today',
  ...
  Object.freeze({
    ...
    name: 'Action Queue / Rapid Delivery desk',
    environment: 'core',
  ...
  Object.freeze({
    ...
    disposition: 'MIGRATE',
    notes: 'REUSE list/detail/actions; extract Prospect Workbench from product brand.',
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    disposition: 'MIGRATE',
    notes: 'Must not remain canonical. Postgres leads + #721 canonical_stage replace it.',
  }),
  Object.freeze({
    path: '/change',
    name: 'Change Console',
