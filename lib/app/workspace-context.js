...
export function workspaceChromeForEnvironment(environment, opts = {}) {
  if (environment === 'tenant') {
    ...
    return {
      ...
      // #1006 — do not advertise the staff chooser (Operating Workspace) to tenants.
      switch_href: '',
      switch_label: '',
      show_switch: false,
    };
...
export const WORKSPACE_SURFACE_MATRIX = Object.freeze([
  ...
  Object.freeze({
    ...
    data_source: 'fixture | cmp_tickets_read',
    disposition: 'CANONICAL',
    notes: 'Existing #778/#877 shell. #1006 tenant-only nav: Requests & Progress + /change. CorpFlowAI uses normal tenant auth.',
  }),
  Object.freeze({
    path: '/app/prospects',
  ...
  Object.freeze({
    ...
    disposition: 'CANONICAL',
    notes: 'Staff-only. Filters shared Prospect Operations with #721 My Work / Today rules. Tenant Workspace omits this route (#1006).',
  }),
  Object.freeze({
 ...
 * Tenant Workspace no longer lists My Work (#1006).
 * @returns {boolean}
 */
