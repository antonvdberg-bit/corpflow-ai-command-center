...
/**
 * Clients summary contract path (#999). Company Master remains the identity
 * source. This #1004 slice links here and does not implement the Clients page.
 */
...
export const WORKSPACE_SURFACE_MATRIX = Object.freeze([
  ...
  Object.freeze({
    ...
    disposition: 'REUSE',
    notes: 'Identity source for #999 Clients summary and #1004 Commercial links. Do not duplicate client identity.',
  }),
]);
