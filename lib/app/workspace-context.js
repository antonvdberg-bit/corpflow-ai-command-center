...
export const WORKSPACE_SURFACE_MATRIX = Object.freeze([
  ...
  Object.freeze({
    ...
    disposition: 'CANONICAL',
    notes: 'Staff-only #1005 / #1184. Projects Lead Rescue, Website Rescue, and Change/request delivery, plus an existing ERPNext Project/Issue reference when corpflow.delivery.erpnext.v1 already names it. No second project system. Tenant 403.',
  }),
  Object.freeze({
