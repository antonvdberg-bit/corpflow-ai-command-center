...
export function projectClientSummary(company, prospects = []) {
  ...
  return {
    ...
    commercial_references: {
      status: 'workspace_module',
      issue: COMMERCIAL_SUMMARY_ISSUE,
      path: COMMERCIAL_SUMMARY_PATH,
      existing_identity_path: COMPANY_MASTER_PATH,
      note: 'Canonical Commercial summary is /app/commercial (#1004). Company Master remains the identity/evidence hub.',
    },
    delivery_references: {
      status: 'not_yet_a_workspace_module',
      ...
      note: 'Delivery summary is a later slice. Tenant service-request stays at /change.',
    },
  };
}
