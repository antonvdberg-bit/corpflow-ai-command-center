#!/usr/bin/env node
/**
 * GET-only ERPNext bank / reconciliation readiness audit (#1139).
 *
...
function printHeader(dryRun) {
  log('ERPNext bank / reconciliation readiness audit (#1139)');
...
async function main() {
  ...
  writeFileSync(
    ...
    [
      '# #1139 bank / reconciliation readiness probe',
      '',
      ...
      `Final verdict: ${CANONICAL_VERDICT}.`,
      '',
    ].join('\n')
  );
  log(`artifact: artifacts/erpnext/bank-reconciliation-readiness-1139/probe-log.json`);
